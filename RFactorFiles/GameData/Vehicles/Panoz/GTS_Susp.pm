// Panoz GTS Suspension Geometry file - Image Space Inc. Copyright 2006
//////////////////////////////////////////////////////////////////////////
//
// Conventions:
//
...
// Front spindles
[BODY]
name=fl_spindle mass=(17.0) inertia=(0.0330,0.0315,0.0300)
pos=(0.71,0.0,-1.65) ori=(0.0,0.0,0.0)

[BODY]
name=fr_spindle mass=(17.0) inertia=(0.0330,0.0315,0.0300)
pos=(-0.71,0.0,-1.65) ori=(0.0,0.0,0.0)

// Front wheels
[BODY]
name=fl_wheel mass=(22.65) inertia=(2.250,1.100,1.100)
pos=(0.71,0.0,-1.65) ori=(0.0,0.0,0.0)

[BODY]
name=fr_wheel mass=(22.65) inertia=(2.250,1.100,1.100)
pos=(-0.71,0.0,-1.65) ori=(0.0,0.0,0.0)

// Live rear axle
[BODY]
name=rear_axle mass=(92.50) inertia=(10.70,10.70,5.20)
pos=(0.0,-0.07,1.35) ori=(0.0,0.0,0.0)

// Rear wheels 
[BODY]
name=rl_wheel mass=(19.20) inertia=(2.250,1.100,1.100)
pos=(0.71,0.0,1.35) ori=(0.0,0.0,0.0)

[BODY]
name=rr_wheel mass=(19.20) inertia=(2.250,1.100,1.100)
pos=(-0.71,0.0,1.35) ori=(0.0,0.0,0.0)
...
name=fl_fore_upper posbody=body negbody=fl_spindle pos=(0.480,0.288,-1.65) neg=(0.583,0.328,-1.650)

[BAR] // rearward upper arm
posbody=body negbody=fl_spindle pos=(0.480,0.288,-1.45) neg=(0.583,0.328,-1.650)
...
name=fl_steering posbody=body negbody=fl_spindle pos=(0.442,-0.104,-1.815) neg=(0.650,-0.088,-1.822)

// Front right suspension (2 A-arms + 1 steering arm = 5 links)
[BAR] // forward upper arm (used in steering lock calculation)
name=fr_fore_upper posbody=body negbody=fr_spindle pos=(-0.480,0.288,-1.65) neg=(-0.583,0.328,-1.650)

[BAR] // rearward upper arm
posbody=body negbody=fr_spindle pos=(-0.480,0.288,-1.45) neg=(-0.583,0.328,-1.650)
...
[BAR] // steering arm (must be named for identification)
name=fr_steering posbody=body negbody=fr_spindle pos=(-0.442,-0.104,-1.815) neg=(-0.650,-0.088,-1.822)
