...
// Front spindles
[BODY]
name=fl_spindle mass=(15.5) inertia=(0.0300,0.0285,0.0270)
pos=( 0.690,0.0,-1.65) ori=(0.0,0.0,0.0)

[BODY]
name=fr_spindle mass=(15.5) inertia=(0.0300,0.0285,0.0270)
pos=(-0.690,0.0,-1.65) ori=(0.0,0.0,0.0)

// Front wheels
[BODY]
name=fl_wheel mass=(24.5) inertia=(1.800,0.970,0.970)
pos=( 0.735,0.0,-1.65) ori=(0.0,0.0,0.0)

[BODY]
name=fr_wheel mass=(24.5) inertia=(1.800,0.970,0.970)
pos=(-0.735,0.0,-1.65) ori=(0.0,0.0,0.0)

// Rear spindles
[BODY]
name=rl_spindle mass=(16.0) inertia=(0.0300,0.0285,0.0270)
pos=( 0.700,0.0,-1.65) ori=(0.0,0.0,0.0)

[BODY]
name=rr_spindle mass=(16.0) inertia=(0.0300,0.0285,0.0270)
pos=(-0.700,0.0,-1.65) ori=(0.0,0.0,0.0)

// Rear wheels 
[BODY]
name=rl_wheel mass=(26.0) inertia=(2.000,1.040,1.040)
pos=( 0.735,0.0,1.35) ori=(0.0,0.0,0.0)

[BODY]
name=rr_wheel mass=(26.0) inertia=(2.000,1.040,1.040)
pos=(-0.735,0.0,1.35) ori=(0.0,0.0,0.0)
...
name=fl_fore_upper posbody=body negbody=fl_spindle pos=(0.410,0.195,-1.65) neg=(0.600,0.205,-1.635)

[BAR] // rearward upper arm
posbody=body negbody=fl_spindle pos=(0.410,0.195,-1.45) neg=(0.600,0.205,-1.635)
...
name=fl_steering posbody=body negbody=fl_spindle pos=(0.250,-0.100,-1.790) neg=(0.617,-0.110,-1.800)


// Front right suspension (2 A-arms + 1 steering arm = 5 links)
[BAR] // forward upper arm (used in steering lock calculation)
name=fr_fore_upper posbody=body negbody=fr_spindle pos=(-0.410,0.195,-1.65) neg=(-0.600,0.205,-1.635)

[BAR] // rearward upper arm
posbody=body negbody=fr_spindle pos=(-0.410,0.195,-1.45) neg=(-0.600,0.205,-1.635)
...
[BAR] // steering arm (must be named for identification)
name=fr_steering posbody=body negbody=fr_spindle pos=(-0.250,-0.100,-1.790) neg=(-0.617,-0.110,-1.800)
...
[BAR] // forward lower arm
posbody=body negbody=rl_spindle pos=(0.280,-0.100,1.25) neg=(0.635,-0.110,1.35)

[BAR] // rearward lower arm
posbody=body negbody=rl_spindle pos=(0.280,-0.100,1.50) neg=(0.635,-0.110,1.35)

[BAR] // straight link
posbody=body negbody=rl_spindle pos=(0.350,-0.005,1.52) neg=(0.635,-0.000,1.52)
...
[BAR] // forward lower arm
posbody=body negbody=rr_spindle pos=(-0.280,-0.100,1.25) neg=(-0.635,-0.110,1.35)

[BAR] // rearward lower arm
posbody=body negbody=rr_spindle pos=(-0.280,-0.100,1.50) neg=(-0.635,-0.110,1.35)

[BAR] // straight link
posbody=body negbody=rr_spindle pos=(-0.350,-0.005,1.52) neg=(-0.635,-0.000,1.52)
