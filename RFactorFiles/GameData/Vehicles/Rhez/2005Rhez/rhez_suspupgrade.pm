...
// Rear spindles
[BODY]
name=rl_spindle mass=(8.0) inertia=(0.0175,0.0160,0.0145)
pos=(0.64,0.0,1.35) ori=(0.0,0.0,0.0)

[BODY]
name=rr_spindle mass=(8.0) inertia=(0.0175,0.0160,0.0145)
pos=(-0.64,0.0,1.35) ori=(0.0,0.0,0.0)
...
[BAR] // steering arm (must be named for identification)
name=fr_steering posbody=body negbody=fr_spindle pos=(-0.205,0.113,-1.725) neg=(-0.637,0.113,-1.735) // Fixed - thanks Speed12!
