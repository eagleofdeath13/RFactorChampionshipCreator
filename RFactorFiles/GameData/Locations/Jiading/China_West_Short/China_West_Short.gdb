China_West_Short	
{
  ...
  Attrition = 30
  TrackName = Jiading West Short Circuit
  EventName =  Jiading Sprint
  GrandPrixName = Jiading Sprint    //this must be the same as event name in order to sort circuit info correctly.
