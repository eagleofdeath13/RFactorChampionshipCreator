NAS_National
{
  ...
  Attrition = 30
  TrackName = Northamptonshire National
  EventName = Sports Car Challenge
  GrandPrixName = Sports Car Challenge //this must be the same as event name in order to sort circuit info correctly.
...
//////////////////////////////////////////////////////////////////////////////////////
  ...
  SettingsFolder = NasNational
  SettingsCopy = Grip.svm
  SettingsCopy = NasNational.svm
  SettingsAI = NasNational.svm
