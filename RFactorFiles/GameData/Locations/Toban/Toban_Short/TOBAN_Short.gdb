TOBAN_Short
{
  ...
  Attrition = 30
  TrackName = Toban Raceway Park Short
  EventName = Toban Raceway Runoffs
  GrandPrixName = Toban Raceway Runoffs		//this must be the same as event name in order to sort circuit info correctly.
  ...
  SettingsFolder = Toban Short
  SettingsCopy = Grip.svm
  SettingsCopy = Toban_short.svm
  SettingsAI = Toban_short.svm
