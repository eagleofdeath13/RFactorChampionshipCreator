TOBAN_Short_REV
{
  ...
  Attrition = 30
  TrackName = Toban Raceway Park Short Rev
  EventName = Toban Short Special Event
  GrandPrixName = Toban SSE		//this must be the same as event name in order to sort circuit info correctly.
  VenueName = Toban Raceway Park
  Location = Toban, IN, USA
  Length = 2.603 km / 1.6 miles
  ...
  SettingsFolder = Toban Short Special
  SettingsCopy = Grip.svm
  SettingsCopy = Toban_Short_Rev.svm
  SettingsAI = Toban_Short_Rev.svm
