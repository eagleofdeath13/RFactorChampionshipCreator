TOBAN_LONG_REV
{
  ...
  Attrition = 30
  TrackName = Toban Raceway Park Long Rev
  EventName = Toban Long Special Event
  GrandPrixName = Toban LSE		//this must be the same as event name in order to sort circuit info correctly.
  ...
  SettingsFolder = Toban Long Special
  SettingsCopy = Grip.svm
  SettingsCopy = TOBAN_LONG_REV.svm
  SettingsAI = TOBAN_LONG_REV.svm
