Nuer_Sprint
{
  ...
  Attrition = 30
  TrackName = Nuerburg Sprint
  EventName = Sprint Showdown
  GrandPrixName = Sprint Showdown //this must be the same as event name in order to sort circuit info correctly.
  VenueName = Nuerburg
...
//////////////////////////////////////////////////////////////////////////////////////
  ...
  SettingsFolder = NuerSprint
  SettingsCopy = Grip.svm
  SettingsCopy = NuerSprint.svm
  SettingsAI = NuerSprint.svm
