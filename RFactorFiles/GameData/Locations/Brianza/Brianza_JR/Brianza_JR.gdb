Brianza_JR
{
  ...
  Attrition = 30
  TrackName = Brianza Junior
  EventName = rTrainer Challenge
  GrandPrixName = rTrainer Challenge //this must be the same as event name in order to sort circuit info correctly.
  VenueName = Autodromo Nazionale della Brianza
  Location = Milano, Italy
  Length = 2.42 km / 1.5 Miles
...
//////////////////////////////////////////////////////////////////////////////////////
  ...
  SettingsFolder = Brianza_JR
  SettingsCopy = Grip.svm
  SettingsCopy = Brianza_JR.svm
  SettingsAI = Brianza_JR.svm
