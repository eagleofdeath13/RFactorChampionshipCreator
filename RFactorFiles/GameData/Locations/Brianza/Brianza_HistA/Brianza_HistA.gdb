Brianza_HistA
{
  ...
  Attrition = 30
  TrackName = Brianza Pirello
  EventName = Brianza Classic - Round 2
  GrandPrixName = Brianza Classic - Round 2 //this must be the same as event name in order to sort circuit info correctly.
  VenueName = Autodromo Nazionale della Brianza
  Location = Milano, Italy
  Length = 4.17 km / 2.59 Miles
...
//////////////////////////////////////////////////////////////////////////////////////
  ...
  SettingsFolder = Brianza_HistA
  SettingsCopy = Grip.svm
  SettingsCopy = Brianza_HistA.svm
  SettingsAI = Brianza_HistA.svm
