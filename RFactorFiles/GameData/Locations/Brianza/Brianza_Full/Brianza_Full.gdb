Brianza_Full
{
  ...
  Attrition = 30
  TrackName = Brianza Full
  EventName = Brianza Classic - Round 4
  GrandPrixName = Brianza Classic - Round 4 //this must be the same as event name in order to sort circuit info correctly.
  VenueName = Autodromo Nazionale della Brianza
  Location = Milano, Italy
  Length = 10.09 km / 6.27 Miles
  TrackType = Permanent Road Course
  Track Record = , 166.300
...
//////////////////////////////////////////////////////////////////////////////////////
  ...
  SettingsFolder = Brianza_Full
  SettingsCopy = Grip.svm
  SettingsCopy = Brianza_Full.svm
  SettingsAI = Brianza_Full.svm
  Qualify Laptime = 112.00
  Race Laptime = 114.50
}
