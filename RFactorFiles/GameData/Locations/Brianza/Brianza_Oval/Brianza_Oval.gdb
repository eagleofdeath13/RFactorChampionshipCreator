Brianza_Oval
{
  ...
  Attrition = 30
  TrackName = Brianza Oval
  EventName = Brianza Classic - Round 1
  GrandPrixName = Brianza Classic - Round 1 //this must be the same as event name in order to sort circuit info correctly.
  VenueName = Autodromo Nazionale della Brianza
  Location = Milano, Italy
  Length = 4.32 km / 2.684 Miles
...
//////////////////////////////////////////////////////////////////////////////////////
  ...
  SettingsFolder = Brianza_Oval
  SettingsCopy = Grip.svm
  SettingsCopy = Brianza_Oval.svm
  SettingsAI = Brianza_Oval.svm
  Qualify Laptime = 62.00
  Race Laptime = 64.50
}
