Mills_Long
{
  ...
  Attrition = 30
  TrackName = Mills Metropark Long
  EventName = Mills Grand Prix
  GrandPrixName = Mills Grand Prix		//this must be the same as event name in order to sort circuit info correctly.
