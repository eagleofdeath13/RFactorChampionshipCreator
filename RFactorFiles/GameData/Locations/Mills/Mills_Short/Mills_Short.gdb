Mills_Short
{
  ...
  Attrition = 30
  TrackName = Mills Metropark Short
  EventName = Sprint at Mills Metropark
  GrandPrixName = Sprint at Mills Metropark	//this must be the same as event name in order to sort circuit info correctly.
  VenueName = Mills Metropark
  Location = Mills City, VA, USA
  Length = 1.846 km / 1.2 miles
  ...
  SettingsFolder = Mills Short
  SettingsCopy = Grip.svm
  SettingsCopy = Mills_Short.svm
  SettingsAI = Mills_Short.svm
