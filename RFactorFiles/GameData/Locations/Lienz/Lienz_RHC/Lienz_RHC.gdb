LIENZ_RHC
{
  ...
  Attrition = 30
  TrackName = Lienz Rally Hillclimb
  EventName = Lienz Week 6 - Rally Hillclimb
  GrandPrixName = Lienz Week 6 - Rally Hillclimb //this must be the same as event name in order to sort circuit info correctly.
  VenueName = Lienz Festival der Geschwindigkeit
  Location = Lienz, Tirol Austria
  Length = 6.78 KM / 4.21 Miles
  TrackType = Temporary Rally Course
  Track Record = Rayzor, 217.88
  ...
  RaceDate = August 26 // default date for the race
...
//////////////////////////////////////////////////////////////////////////////////////
  ...
  SettingsFolder = Lienz_RHC
  SettingsCopy = Grip.svm
  SettingsCopy = Lienz_RHC.svm
  SettingsAI = Lienz_RHC.svm
  Qualify Laptime = 224.73
  Race Laptime = 225.99
}
