LIENZ_GP
{
  ...
  Attrition = 30
  TrackName = Lienz GP Long
  EventName = Lienz Week 4 - GP Long
  GrandPrixName = Lienz Week 4 - GP Long //this must be the same as event name in order to sort circuit info correctly.
  VenueName = Lienz Festival der Geschwindigkeit
  Location = Lienz, Tirol Austria
  Length = 7.23 KM / 4.49 Miles
  TrackType = Temporary Road Course
  Track Record = Rayzor, 190.00
  ...
  RaceDate = August 12 // default date for the race
...
//////////////////////////////////////////////////////////////////////////////////////
  ...
  SettingsFolder = Lienz_GPLong
  SettingsCopy = Grip.svm
  SettingsCopy = Lienz_GPLong.svm
  SettingsAI = Lienz_GPLong.svm
  Qualify Laptime = 192.00
  Race Laptime = 196.00
}
