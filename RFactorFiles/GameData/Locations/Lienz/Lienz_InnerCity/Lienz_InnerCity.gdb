LIENZ_INNERCITY
{
  ...
  Attrition = 30
  TrackName = Lienz Altstadt
  EventName = Lienz Week 1 - Altstadt
  GrandPrixName = Lienz Week 1 - Altstadt //this must be the same as event name in order to sort circuit info correctly.
  VenueName = Lienz Festival der Geschwindigkeit
  Location = Lienz, Tirol Austria
  Length = 1.53 KM / 0.95 Miles
  TrackType = Temporary Road Course
  Track Record = Venom, 46.88
...
//////////////////////////////////////////////////////////////////////////////////////
  ...
  SettingsFolder = Lienz_Altstadt
  SettingsCopy = Grip.svm
  SettingsCopy = Lienz_Altstadt.svm
  SettingsAI = Lienz_Altstadt.svm
  Qualify Laptime =46.4
  Race Laptime = 47.9
}
