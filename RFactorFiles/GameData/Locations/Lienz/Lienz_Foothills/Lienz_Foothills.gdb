LIENZ_FOOTHILLS
{
  ...
  Attrition = 30
  TrackName = Lienz GP Short
  EventName = Lienz Week 2 - GP Short
  GrandPrixName = Lienz Week 2 - GP Short //this must be the same as event name in order to sort circuit info correctly.
  VenueName = Lienz Festival der Geschwindigkeit
  Location = Lienz, Tirol Austria
  Length = 2.68 KM / 1.66 Miles
  TrackType = Temporary Road Course
  Track Record = Rhez 2006, 56.00
  ...
  RaceDate = July 29   // default date for the race
...
//////////////////////////////////////////////////////////////////////////////////////
  ...
  SettingsFolder = Lienz_GPShort
  SettingsCopy = Grip.svm
  SettingsCopy = Lienz_GPShort.svm
  SettingsAI = Lienz_GPSHORT.svm
  Qualify Laptime = 55.00
  Race Laptime = 57.50
}
